...
const ManageOrder = () => {
    ...
    useEffect(() => {
        fetch('https://haunted-hollow-87054.herokuapp.com/orders')
            .then(res => res.json())
    ...
    const handleUpdate = order => {
        ...
        if (proceed) {
            ...
            const url = `https://haunted-hollow-87054.herokuapp.com/orders/${order._id}`
            fetch(url, {
                method: 'PUT',
                headers: {
    ...
    const handleDelete = id => {
        ...
        const url = `https://haunted-hollow-87054.herokuapp.com/orders/${id}`
    ...
    return (
        <div className="container">
            <h1 className="m-5 p-5">Mange Orders</h1>
